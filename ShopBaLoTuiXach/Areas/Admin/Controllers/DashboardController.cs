...
namespace ShopBaLoTuiXach.Areas.Admin.Controllers
{

    public class DashboardController : BaseController
    {
        private ShopBaLoTuiXachDbContext db = new ShopBaLoTuiXachDbContext();
        // GET: Admin/Dashboard
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Neworder = db.Orders.Where(m => m.status == 0).Count();
            ViewBag.contact = db.Contacts.Where(m => m.status == 0).Count();
